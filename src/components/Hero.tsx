      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-2 px-6 py-3 rounded-full glass-cosmic mb-8"
          >
            <Sparkles className="w-5 h-5 text-cosmic-400" />
            <span className="text-lg font-display font-medium bg-gradient-to-r from-cosmic-400 to-nebula-400 bg-clip-text text-transparent">
              TỤI MÌNH CƯỚI
            </span>
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-7xl lg:text-9xl font-display font-bold mb-8 text-glow-lg"
          >
            <span className="block bg-gradient-to-r from-cosmic-400 via-nebula-400 to-aurora-400 bg-clip-text text-transparent">
              Thanh Hằng
            </span>
            <motion.span 
              className="block text-4xl sm:text-6xl lg:text-8xl mt-4 text-white/90"
              animate={{ 
                textShadow: [
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl lg:text-3xl font-light mb-4 text-white/80"
          >
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-2 px-4 py-2 rounded-full glass-cosmic mb-12"
          >
            <span className="text-lg font-mono text-cosmic-300">
              29 Tháng 03, 2026
            </span>
          </motion.div>
          ...
          >
            <button
              ...
              className="btn-cosmic text-lg px-10 py-4"
            >
            ...
            <button
              ...
              className="btn-outline-cosmic text-lg px-10 py-4"
            >
              <span className="relative z-10 flex items-center space-x-2">
