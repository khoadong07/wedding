...
const StoryCard: React.FC<StoryCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 space-y-8">
        <div className="flex items-center space-x-6">
          <motion.div 
            ...
            className={`w-16 h-16 rounded-full flex items-center justify-center text-white font-bold text-xl cosmic-border ${gradient}`}
          >
            <Icon className="w-8 h-8" />
          </motion.div>
          <div>
            <div className="text-sm font-mono text-cosmic-400 mb-2">
              Chapter {number}
            </div>
            <h3 className="text-3xl lg:text-4xl font-display font-bold bg-gradient-to-r from-cosmic-400 via-nebula-400 to-aurora-400 bg-clip-text text-transparent">
              {title}
            </h3>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          {/* Cosmic glow effect */}
          <div className="absolute -left-4 top-0 w-1 h-full bg-gradient-to-b from-cosmic-400 via-nebula-400 to-aurora-400 rounded-full opacity-50" />
        </div>
      </div>
      ...
      >
        <div className="relative overflow-hidden rounded-3xl cosmic-border">
          <picture>
...
const Story: React.FC = () => {
  ...
  const stories = [
    ...
    },
    {
      ...
      imageSrc: 'assets/A%20KHOA%20-%20C%20HANG_03.jpg',
      imageAlt: 'Eternal Bond',
      webpSrcSet: 'optimized/A%20KHOA%20-%20C%20HANG_03-480.webp 480w, optimized/A%20KHOA%20-%20C%20HANG_03-768.webp 768w, optimized/A%20KHOA%20-%20C%20HANG_03-1200.webp 1200w',
      icon: Heart,
    ...
    <section id="story" className="section-padding relative overflow-hidden">
      ...
      <div className="container-cosmic relative z-10">
        ...
        >
          ...
          >
            <Star className="w-8 h-8 text-cosmic-400" />
          </motion.div>
          
          <h2 className="text-5xl lg:text-6xl font-display font-bold mb-8 bg-gradient-to-r from-cosmic-400 via-nebula-400 to-aurora-400 bg-clip-text text-transparent">
            Cosmic Love Story
          </h2>
